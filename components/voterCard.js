...
const VoterCard = ({candidateDetails}) => {
  ...
  return (
    ...
    <h1 className='flex justify-center items-center text-2xl text-white font-bold uppercase '>NAME</h1>
        <h1 className='flex justify-center items-center text-white font-bold uppercase mt-1'>{candidateDetails[5].name}</h1>
    </div>
     <div>
     <h1 className='flex justify-center items-center text-2xl text-white font-bold uppercase mt-3'>VOTES</h1>
        <p className='flex justify-center items-center text-sm text-white font-bold uppercase mt-1'>{candidateDetails[5].numVotes.toString()}</p>
     </div>
       </div>
  )
}
